...
def get_pilot_preflight(tenant_id: str, db: Session = Depends(get_session)) -> dict[str, object]:
...
def get_pilot_hold_point(tenant_id: str, db: Session = Depends(get_session)) -> dict[str, object]:
