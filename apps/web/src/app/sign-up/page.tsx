      ...
      <FadeUp className="w-full max-w-md relative z-10">
        <div className="glass neon-border rounded-2xl p-8 sm:p-10 border border-[#ff2d78]/30 shadow-[0_0_50px_rgba(0,0,0,0.5)]">
          <div className="text-center mb-8">
            ...
            <h1 className="font-headline font-bold text-2xl sm:text-3xl text-[#e8e0f0]">Request a Pilot</h1>
            <p className="text-sm text-[#a098b0] mt-2 font-body">Deploy VoxFlow voice operations for your team</p>
          </div>

          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            <div>
              <label htmlFor="name" className="text-xs font-label uppercase tracking-widest text-[#e8e0f0] block mb-1.5">Full Name</label>
              <input
                id="name"
                type="text"
            ...
            <div>
              <label htmlFor="company" className="text-xs font-label uppercase tracking-widest text-[#e8e0f0] block mb-1.5">Company / Operation</label>
              <input
                id="company"
                type="text"
