...
const NAV = [
  ...
  { href: "/dashboard/calls", label: "Calls & Audio", icon: PhoneCall },
  ...
  { href: "/dashboard/settings", label: "Agent & SaaS Settings", icon: Sliders },
  { href: "https://github.com/jeevesh2515/voxflow-voice-agent", label: "Docs & GitHub", icon: FileText, external: true },
];
              ...
              >
                <Icon
                  ...
                  className={clsx(
                    ...
                    active ? "text-[#ff2d78]" : "text-[#a098b0]",
                  )}
                />
        ...
        <div className="mt-auto p-4 space-y-3 border-t border-[#302840]/40">
          <div className="glass-panel p-3 rounded-lg border border-[#00ffcc]/20 flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <span className="text-[10px] text-[#a098b0] uppercase font-bold tracking-widest font-label">
                Voice Queue
              </span>
          ...
          <div className="glass-panel p-3 rounded-lg border border-[#ff2d78]/20 flex items-center gap-3">
            ...
            <div>
              <p className="text-[9px] text-[#a098b0] uppercase font-bold font-label tracking-widest">
                LangSmith Status
              </p>
              <p className="text-xs font-headline font-bold text-[#00ffcc]">Tracing Active</p>
            </div>
          </div>
        </div>
      </aside>
