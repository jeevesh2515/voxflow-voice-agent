...
export default function ParallaxQuotes() {
  return (
    <section className="parallax-quotes relative min-h-[140svh]" aria-label="Customer outcomes">
      {/* Locked background layer: deep starfield, no hero imagery. */}
      <div className="parallax-quotes-backdrop sticky top-0 h-[100svh] overflow-hidden" aria-hidden="true">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/space-starfield.jpg"
          alt=""
          className="absolute inset-0 h-full w-full object-cover opacity-60"
        />
        {/* Readability scrim — heavier at the centre where the text lands. */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,rgba(5,5,10,0.80)_0%,rgba(5,5,10,0.55)_48%,rgba(5,5,10,0.88)_100%)]" />
      </div>
